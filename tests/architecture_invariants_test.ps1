...
Require-Text 'SideKick.lua' "'action:manual'" 'manual ability Actor routing'
Require-Text 'sk_items.lua' "registerMessageCallback('action:manual'" 'manual ability worker receiver'
...
Require-Text 'ui/remote_abilities.lua' 'ActorsCoordinator.sendToCharacter(' 'leased remote ability routing'
